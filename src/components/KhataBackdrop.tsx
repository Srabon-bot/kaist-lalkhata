 ...
 * the background of WelcomePage — sits as a sibling behind page content
 ...
 * core UI feedback, so a continuous loop is fine here and is neutralized
 * globally under prefers-reduced-motion via the blanket rule in index.css.
 *
 * Purely decorative — the real book (opening/closing/page-flip) lives in
 * BookPage + Layout, not here.
 */
