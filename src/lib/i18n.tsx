...
export const dict = {
  ...
  "mic.structureHintSale": {
    ...
    // English now supports a bn/ko-style terse slot order too (see the
    // "Terse slot format" branch of extractEn in localExtraction.ts): name,
    // then item, then amount, "credit" only if it's a credit sale — no verb
    // needed. A full verb sentence ("Rohim bought biscuits worth 500 taka")
    // still works via the verb-anchored branches; this is just the faster
    // alternative the hint leads with.
    en: 'Name, item, amount — add "credit" if it\'s on credit, e.g. "Rohim biscuits 500 credit"',
    ko: "외상/현금 판매: 이름, 그다음 금액과 물건",
  },
  "mic.structureHintRepayment": {
    bn: "বাকি শোধ: শুধু নাম আর টাকা",
    en: 'Name, then "repaid", then amount, e.g. "Salma repaid 200"',
    ko: "외상 상환: 이름과 금액만",
  },
  ...
  "auth.confirmPassword": { bn: "পাসওয়ার্ড নিশ্চিত করুন", en: "Confirm password", ko: "비밀번호 확인" },
  "auth.showPassword": { bn: "পাসওয়ার্ড দেখান", en: "Show password", ko: "비밀번호 표시" },
  "auth.hidePassword": { bn: "পাসওয়ার্ড লুকান", en: "Hide password", ko: "비밀번호 숨기기" },
  "auth.orContinueWith": { bn: "অথবা চালিয়ে যান", en: "or continue with", ko: "또는 다음으로 계속" },
  "auth.continueWithGoogle": { bn: "Google দিয়ে চালিয়ে যান", en: "Continue with Google", ko: "Google로 계속하기" },
  "auth.googleUnavailable": {
    bn: "Google সাইন-ইন এখনো সেট আপ করা হয়নি",
    en: "Google sign-in isn't set up yet",
    ko: "Google 로그인이 아직 설정되지 않았습니다",
  },
  "auth.switchToLogin": { bn: "অ্যাকাউন্ট আছে? লগইন করুন", en: "Already have an account? Log in", ko: "이미 계정이 있으신가요? 로그인" },
  "auth.switchToSignup": { bn: "নতুন? সাইন আপ করুন", en: "New here? Sign up", ko: "처음이신가요? 회원가입" },
  "auth.passwordReqLength": { bn: "কমপক্ষে ৮ অক্ষর", en: "At least 8 characters", ko: "최소 8자 이상" },
  "auth.passwordReqUpper": { bn: "একটি বড় হাতের অক্ষর (A-Z)", en: "One uppercase letter (A-Z)", ko: "대문자 하나 (A-Z)" },
  "auth.passwordReqLower": { bn: "একটি ছোট হাতের অক্ষর (a-z)", en: "One lowercase letter (a-z)", ko: "소문자 하나 (a-z)" },
  "auth.passwordReqNumber": { bn: "একটি সংখ্যা (0-9)", en: "One number (0-9)", ko: "숫자 하나 (0-9)" },
  "auth.passwordReqSymbol": { bn: "একটি চিহ্ন (!@#...)", en: "One symbol (!@#...)", ko: "기호 하나 (!@#...)" },
  "auth.strengthLabel": { bn: "পাসওয়ার্ডের শক্তি", en: "Password strength", ko: "비밀번호 강도" },
  "auth.strengthWeak": { bn: "দুর্বল", en: "Weak", ko: "약함" },
  "auth.strengthFair": { bn: "মোটামুটি", en: "Fair", ko: "보통" },
  "auth.strengthGood": { bn: "ভালো", en: "Good", ko: "좋음" },
  "auth.strengthStrong": { bn: "শক্তিশালী", en: "Strong", ko: "강함" },
  "auth.errorEmailTaken": {
    bn: "এই ইমেইল দিয়ে আগে থেকেই একটি অ্যাকাউন্ট আছে",
    en: "An account with this email already exists",
    ko: "이 이메일로 이미 계정이 있습니다",
  },
  "auth.errorNotFound": {
    bn: "এই ইমেইলে কোনো অ্যাকাউন্ট পাওয়া যায়নি",
    en: "No account found with this email",
    ko: "이 이메일로 등록된 계정이 없습니다",
  },
  "auth.errorWrongPassword": { bn: "পাসওয়ার্ড ভুল হয়েছে", en: "That password isn't right", ko: "비밀번호가 올바르지 않습니다" },
  "auth.errorWrongProvider": {
    bn: "এই অ্যাকাউন্টটি Google দিয়ে সাইন ইন করা — Google ব্যবহার করুন",
    en: "This account signs in with Google — use that instead",
    ko: "이 계정은 Google로 로그인합니다 — Google을 사용하세요",
  },
  "auth.errorPasswordMismatch": { bn: "পাসওয়ার্ড দুটি মিলছে না", en: "Passwords don't match", ko: "비밀번호가 일치하지 않습니다" },
  "auth.errorWeakPassword": { bn: "পাসওয়ার্ড আরও শক্তিশালী হতে হবে", en: "Password needs to be stronger", ko: "비밀번호가 더 강력해야 합니다" },
  "auth.errorGeneric": {
  ...
  "username.title": { bn: "একটি ব্যবহারকারীর নাম বাছুন", en: "Pick a username", ko: "사용자 이름을 선택하세요" },
  "username.subtitle": {
    bn: "এই নামটি খাতায় আপনার দোকানের নাম হিসেবে দেখা যাবে।",
    en: "This is what shows as your shop's name in the ledger.",
    ko: "이 이름이 장부에서 가게 이름으로 표시됩니다.",
  },
  "username.label": { bn: "দোকানের নাম বা আপনার নাম", en: "Shop name or your name", ko: "가게 이름 또는 이름" },
  "username.placeholder": { bn: "যেমন: রহিম স্টোর", en: "e.g. Rahim Store", ko: "예: 라힘 스토어" },
  "username.cta": { bn: "চালিয়ে যান", en: "Continue", ko: "계속" },
